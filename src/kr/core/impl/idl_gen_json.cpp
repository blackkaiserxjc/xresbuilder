...
public:
    ...
    JsonVisitor(std::string &writer, uint32_t field_name_case,
        ...
        : writer_{writer}, field_name_case_{field_name_case}, indent_step_{indent_step}, indent_string_{}, is_map_key(false), ctx_{}, map_level_{}
    {
    }
...
private:
    ...
    void write_indent()
    {
        writer_ += fmt::format("{}", indent_string_);
    }
