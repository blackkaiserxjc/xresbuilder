...
std::string DataColumn::toString() const
{
...
void DataColumnCollection::add(size_t index, std::shared_ptr<DataColumn> column)
{   
...
{   
    ...
    if (auto iter = collect.dict_.find((*viter)->name()); iter != collect.dict_.end())
    {
