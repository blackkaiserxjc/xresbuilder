...
IDLParser::IDLParser(TokenStream *input)
    : Parser(input)
{
...
IDLParser::PodContext *IDLParser::pod()
{
    ...
    try
    {
        ...
        setState(19);
        _la = _input->LA(1);
        if (!((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << IDLParser::Bool) | (1ULL << IDLParser::Int) | (1ULL << IDLParser::Long) | (1ULL << IDLParser::Float) | (1ULL << IDLParser::String))) != 0)))
        {
