...
CellParser::CellParser(TokenStream *input)
    : Parser(input)
{
...
CellParser::PodContext *CellParser::pod()
{
    ...
    try
    {
        ...
        setState(31);
        _la = _input->LA(1);
        if (!((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << CellParser::IntegerLiteral) | (1ULL << CellParser::FloatingLiteral) | (1ULL << CellParser::StringLiteral) | (1ULL << CellParser::BooleanLiteral))) != 0)))
        {
...
CellParser::ArrayContext *CellParser::array()
{
    ...
    try
    {
        ...
        _errHandler->sync(this);
        _la = _input->LA(1);
        while ((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << CellParser::IntegerLiteral) | (1ULL << CellParser::FloatingLiteral) | (1ULL << CellParser::StringLiteral) | (1ULL << CellParser::BooleanLiteral) | (1ULL << CellParser::LeftBracket))) != 0))
        {
            setState(34);
            statement();
            setState(39);
